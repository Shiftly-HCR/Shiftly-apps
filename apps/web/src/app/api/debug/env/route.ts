...
export async function GET() {
  const env = {
    ...
    STRIPE_PRICE_FREELANCE_WEEKLY:
      process.env.STRIPE_PRICE_FREELANCE_WEEKLY || "MANQUANTE",
    STRIPE_PRICE_FREELANCE_MONTHLY:
      process.env.STRIPE_PRICE_FREELANCE_MONTHLY || "MANQUANTE",
    STRIPE_PRICE_FREELANCE_ANNUAL:
      process.env.STRIPE_PRICE_FREELANCE_ANNUAL || "MANQUANTE",
